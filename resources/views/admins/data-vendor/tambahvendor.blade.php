            ...
            <form class="needs-validation" method="post" action="{{ route('datavendor.store') }} ">
                ...
                <div class="form-row" style="text-align: center">
                    ...
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <input type="number" id="#" name="harga" placeholder="45000" class="form-control input-lg" required>
                    </div>
                    <br>
                    <br>
                    <br>
                    ...
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="PT.A" name="nama_vendor" required>
                    </div>
                    <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <input type="text" class="form-control" id="NoHp" placeholder="08912345678" name="no_telp" required>
                    </div>
                    <div class="col-md-3 mb-3 input-group-sm">
